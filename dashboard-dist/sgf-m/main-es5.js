  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function JMX(module, __webpack_exports__, __webpack_require__) {
      ...
      var CrudService = /*#__PURE__*/function () {
        function CrudService(http, apollo) {
        ...
        _createClass(CrudService, [{
          key: "postObject",
          value: function postObject(data, endPoint) {
          ...
          key: "pullData",
          value: function pullData(query, data) {
          ...
          key: "postData",
          value: function postData(query, _postData) {
          ...
          key: "calculatePercantage",
          value: function calculatePercantage(a, b, t, aggregation) {
            var value = 0;
      ...
      CrudService.ɵfac = function CrudService_Factory(t) {
        return new (t || CrudService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](apollo_angular__WEBPACK_IMPORTED_MODULE_3__["Apollo"]));
      };
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\Users\adek4\Documents\Natview\sgf-dashboard\src\main.ts */
      "zUnb");
      /***/
    },
    ...
    function TT(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "GuageComponent", function () {
      ...
      var GuageComponent = /*#__PURE__*/function () {
        function GuageComponent() {
          _classCallCheck(this, GuageComponent);
        }

        _createClass(GuageComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var gauge = this.Gauge(document.getElementById("gauge"));
            var percent = this.getPercentage() / 100;
          ...
          key: "Gauge",
          value: function Gauge(el) {
            // ##### Private Properties and Attributes
            var _element,
                // Containing element for the info component
            data,
                // `.gauge--data` element
            needle,
                // `.gauge--needle` element
            _value = 0.0,
                // Current gauge value from 0 to 1
            prop; // Style for transform
            // ##### Private Methods and Functions


            var setElement = function setElement(el) {
              // Keep a reference to the various elements and sub-elements
              _element = el;
              data = _element.querySelector(".gauge--data");
              needle = _element.querySelector(".gauge--needle");
            };
      ...
      GuageComponent.ɵfac = function GuageComponent_Factory(t) {
        return new (t || GuageComponent)();
      };

      GuageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: GuageComponent,
        selectors: [["app-guage"]],
        inputs: {
        ...
        decls: 14,
        vars: 9,
        consts: [["id", "gauge", 1, "gauge", "gauge__liveupdate"], ["id", "gauge-container", 1, "gauge--container"], [1, "gauge--marker"], [1, "gauge--background"], [1, "gauge--center"], [1, "gauge--data", 3, "ngStyle"], [1, "gauge--needle"], [1, "gauge--labels", "mdl-typography--headline"], [1, "gauge--label__low"], [1, "gauge--label__spacer", 2, "text-align", "center", "font-size", "1.5rem", 3, "ngStyle"], [1, "gauge--label__high"]],
        template: function GuageComponent_Template(rf, ctx) {
          if (rf & 1) {
    ...
    function KHl(module, __webpack_exports__, __webpack_require__) {
      ...
      var uri = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverUrl + "graphql"; // <-- add the URL of the GraphQL server here
    ...
    /***/
    function nnL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var src_app_service_crud_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      function UserLoginComponent_p_19_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserLoginComponent_div_22_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserLoginComponent_div_22_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function UserLoginComponent_div_25_div_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div");
      ...
      function UserLoginComponent_div_25_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div", 21);
      ...
      var UserLoginComponent = /*#__PURE__*/function () {
        function UserLoginComponent(formBuilder, router, crud) {
        ...
        _createClass(UserLoginComponent, [{
          ...
          value: function login() {
            ...
            var query = apollo_angular__WEBPACK_IMPORTED_MODULE_1__["gql"](_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    mutation login(\n      $email: String!\n      $password: String!){\n        login(email: $email, password: $password) {\n          token,\n          user{\n            id \n            name\n            access\n            email\n            role{\n              name\n              permissions\n            }\n            mda{\n              id\n              name\n              shortcode\n            }\n          }\n        }\n      }\n    "])));
            this.crud.postData(query, this.postForm.value).subscribe(function (result) {
              if (!result.data['login']) {
                _this.error = result.errors[0].message;
              }
      ...
      UserLoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        decls: 31,
        vars: 12,
        consts: [[1, "wrapper", "d-flex", "justify-content-center", "align-items-center", "justify-content-center"], [1, "primary-border", "d-flex", "p-0", "col-7", "h-75"], [1, "image-content", "d-flex", "justify-content-around", "flex-column", "col-5", "text-center"], [3, "routerLink"], ["src", "assets/images/Coat_of_arms_of_Nigeria.png", "height", "200px"], [1, "col-7", "d-flex", "justify-content-center", "align-items-center"], [1, "w-75"], [1, "text-center", "mb-5"], [1, "mb-4"], [1, "text-warning"], [3, "formGroup", "ngSubmit"], ["class", "text-center m-2 error", 4, "ngIf"], [1, "form-group"], ["type", "text", "formControlName", "email", "required", "", "placeholder", "Email", 1, "form-control", 3, "ngClass"], ["class", "invalid-feedback", 4, "ngIf"], ["type", "password", "formControlName", "password", "required", "", "placeholder", "Password", 1, "form-control", 3, "ngClass"], [1, "form-group", "text-right"], [1, "cursor"], [1, "form-group", "text-center"], ["type", "submit", "value", "Login", 1, "btn", "btn-success", "px-5"], [1, "text-center", "m-2", "error"], [1, "invalid-feedback"], [4, "ngIf"]],
        template: function UserLoginComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngSubmit", function UserLoginComponent_Template_form_ngSubmit_18_listener() {
              return ctx.login();
            });
    ...
    function H3(module, __webpack_exports__, __webpack_require__) {
      ...
      function SettingsComponent_div_87_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function SettingsComponent_div_87_Template_input_ngModelChange_1_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4);

            var ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r3.activeYear = $event;
          });
      ...
      var _c0 = function _c0() {
        return ["/dashboard/mandates"];
      };

      var SettingsComponent = /*#__PURE__*/function () {
        function SettingsComponent(toastr) {
      ...
      SettingsComponent.ɵfac = function SettingsComponent_Factory(t) {
        return new (t || SettingsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_toastr__WEBPACK_IMPORTED_MODULE_1__["ToastrService"]));
      };
      ...
      SettingsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function SettingsComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SettingsComponent_Template_button_click_88_listener() {
    ...
    /***/
    function TvS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PresidentialMandateComponent", function () {
        return PresidentialMandateComponent;
      });
      /* harmony import */
      ...
      var ngx_bootstrap_accordion__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      var angular_2_dropdown_multiselect__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! angular-2-dropdown-multiselect */
      "HoCe");

      function PresidentialMandateComponent_accordion_group_8_li_5_img_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 15);
        }
      }

      function PresidentialMandateComponent_accordion_group_8_li_5_img_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 16);
        }
      }

      function PresidentialMandateComponent_accordion_group_8_li_5_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" \xA0\xA0 ", ind_r6.title, "");
        }
      }

      function PresidentialMandateComponent_accordion_group_8_li_8_img_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 15);
        }
      }

      function PresidentialMandateComponent_accordion_group_8_li_8_img_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelement"](0, "img", 16);
        }
      }

      function PresidentialMandateComponent_accordion_group_8_li_8_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" \xA0\xA0 ", out_r11.title, "");
        }
      }

      function PresidentialMandateComponent_accordion_group_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function PresidentialMandateComponent_ng_template_9_span_16_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function PresidentialMandateComponent_ng_template_9_span_21_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "span", 38);
      ...
      function PresidentialMandateComponent_ng_template_9_span_26_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "span", 38);
      ...
      function PresidentialMandateComponent_ng_template_9_span_31_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "span", 38);
      ...
      function PresidentialMandateComponent_ng_template_9_span_36_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "span", 38);
      ...
      function PresidentialMandateComponent_ng_template_9_span_37_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "span", 38);
      ...
      function PresidentialMandateComponent_ng_template_9_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function PresidentialMandateComponent_ng_template_9_Template_button_click_3_listener() {
      ...
      var PresidentialMandateComponent = /*#__PURE__*/function () {
        // tslint:disable-next-line:max-line-length
        function PresidentialMandateComponent(fb, crudService, modalService, router, data) {
          _classCallCheck(this, PresidentialMandateComponent);
          ...
          this.preffered = []; // Settings configuration
        ...
        _createClass(PresidentialMandateComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.initiateChart();
            this.getPriorities();
            var pref = JSON.parse(localStorage.getItem('preffered'));
            if (pref != undefined) this.preffered = pref;
          }
        }, {
          key: "mandateFormGroup",
          value: function mandateFormGroup() {
            return {
              title: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
              optionsModel: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
              ...
              baseline: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
              deadline: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].minLength(4), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].maxLength(4), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].min(2019), _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].max(2023)])
            };
          }
        }, {
          key: "mandateForm",
          ...
          key: "initiateChart",
          value: function initiateChart() {// setTimeout(() => {
            //   let counter = 0;
          ...
          value: function getPriorities() {
            ...
            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    {\n      priorities(tree: 1){\n        id\n        title\n        indicators{\n            id\n            title\n            ref\n            type\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            mdaId\n            driver\n            outputs{\n              id\n              title\n              ref\n              baseline\n              actual\n              target\n              aggregation\n              rt\n              currency\n              active\n              mdaId\n              mda{\n                id\n                name\n                shortcode\n              }\n              projects{\n                id\n                title\n                status\n              }\n            }\n          }\n        }\n      }\n  "])));
            this.crudService.pullData(data, {}).subscribe(function (result) {
              // this.currentPriorities = ''
              _this2.priorities = result.data.priorities; // this.temp = result.data.priorities;
          ...
          key: "addToPreffered",
          value: function addToPreffered(ind, type) {
            console.log(this.preffered, ind); // let pref = { indicator: ind.id };

            console.log(this.checkPref(ind.id));

            if (this.checkPref(ind)) {
              var index = this.preffered.indexOf(ind);
          ...
          key: "checkPref",
          value: function checkPref(data) {
            var check = false;
            this.preffered.forEach(function (element) {
              if (element.id == data.id) check = true;
            });
            return check;
          }
        }, {
          key: "clearSetting",
          value: function clearSetting() {
      ...
      PresidentialMandateComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        template: function PresidentialMandateComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function PresidentialMandateComponent_Template_button_click_4_listener() {
              return ctx.clearSetting();
            });
    ...
    /***/
    function AwSQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function CJl5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "EwsComponent", function () {
        return EwsComponent;
      });
      /* harmony import */
      ...
      var EwsComponent = /*#__PURE__*/function () {
        function EwsComponent() {
          _classCallCheck(this, EwsComponent);
        }

        _createClass(EwsComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);
      ...
      EwsComponent.ɵfac = function EwsComponent_Factory(t) {
        return new (t || EwsComponent)();
      };

      EwsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: EwsComponent,
        selectors: [["app-ews"]],
        decls: 49,
        vars: 0,
        consts: [[1, "container"], [1, "form-group", "has-search"], [1, "fa", "fa-search", "form-control-feedback"], ["type", "text", "placeholder", "Search", 1, "form-control"], [1, "col-12"], [1, "list-group", "primary-border", "text-center", "mb-3"], [1, "list-group-item", "py-4", "d-flex", "justify-content-between"], [1, "list-group-item", "py-3", "text-left", "mb-0", "pr-5"], [1, "mr-3"], [1, "ml-3"], ["src", "assets/icons/red-warning.svg", 1, "cursor", "mr-3"], [2, "text-decoration", "underline"], ["src", "assets/icons/slight-warning.svg", 1, "cursor", "mr-3"]],
        template: function EwsComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](29, " \xA0\xA0\xA0 ");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](36, " \xA0\xA0\xA0 ");
    ...
    /***/
    function Lz8j(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PhotoStoryComponent", function () {
      ...
      function PhotoStoryComponent_div_0_img_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function PhotoStoryComponent_div_0_video_2_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function PhotoStoryComponent_div_0_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var PhotoStoryComponent = /*#__PURE__*/function () {
        function PhotoStoryComponent() {
          _classCallCheck(this, PhotoStoryComponent);
        ...
        _createClass(PhotoStoryComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
      ...
      PhotoStoryComponent.ɵfac = function PhotoStoryComponent_Factory(t) {
        return new (t || PhotoStoryComponent)();
      };

      PhotoStoryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: PhotoStoryComponent,
        selectors: [["app-photo-story"]],
        inputs: {
          images: "images"
        },
        decls: 1,
        vars: 1,
        consts: [["class", "img-container", 4, "ngFor", "ngForOf"], [1, "img-container"], ["alt", "image slide", "style", "display: block; width: 100%; height: 12.5rem;", 3, "src", 4, "ngIf"], ["width", "200", "height", "120", "controls", "", 4, "ngIf"], ["alt", "image slide", 2, "display", "block", "width", "100%", "height", "12.5rem", 3, "src"], ["width", "200", "height", "120", "controls", ""], ["type", "video/mp4", 3, "src"]],
        template: function PhotoStoryComponent_Template(rf, ctx) {
          if (rf & 1) {
    ...
    /***/
    function N58W(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AllMandatesComponent", function () {
        return AllMandatesComponent;
      });
      /* harmony import */
      ...
      var AllMandatesComponent = /*#__PURE__*/function () {
        function AllMandatesComponent() {
          _classCallCheck(this, AllMandatesComponent);

          this.p = 1;
          this.collection = [{
            id: 'hgjkas98',
            title: 'Real Economic Growth',
            checkedId: 'jigu789',
        ...
        _createClass(AllMandatesComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this3 = this;

            setTimeout(function () {
              _this3.initiateChart();
            }, 2000);
          }
        }, {
          key: "initiateChart",
          value: function initiateChart() {
            ...
            this.collection.forEach(function (element) {
              counter = counter + 1;
              _this4.chart = new Chart('myChart' + counter, {
                type: "tsgauge",
                data: {
                  datasets: [{
                    backgroundColor: ["red", "#fd9704", "#0fdc63"],
      ...
      AllMandatesComponent.ɵfac = function AllMandatesComponent_Factory(t) {
        return new (t || AllMandatesComponent)();
      };

      AllMandatesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: AllMandatesComponent,
        selectors: [["app-all-mandates"]],
        decls: 0,
        vars: 0,
        template: function AllMandatesComponent_Template(rf, ctx) {},
    ...
    function OVWj(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_service_crud_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! src/app/service/crud.service */
      "+JMX");
      /* harmony import */
      ...
      var _photo_story_photo_story_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./photo-story/photo-story.component */
      "Lz8j");
      /* harmony import */
      ...
      var _suffixes_pipe__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../suffixes.pipe */
      "WHRT");

      function ProjectDetailsComponent_div_89_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ProjectDetailsComponent_div_90_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function ProjectDetailsComponent_tr_119_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ProjectDetailsComponent_tr_119_Template_span_click_22_listener() {
            ...
            var _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](138);

            ctx_r7.singleReport = project_r5;
            return _r3.show();
          });
      ...
      function ProjectDetailsComponent_div_149_li_19_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ProjectDetailsComponent_div_149_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var ProjectDetailsComponent = /*#__PURE__*/function () {
        function ProjectDetailsComponent(router, crud, modalService) {
          ...
          this.lng = 7.809007;
          this.p = 1;
          this.images = ['https://via.placeholder.com/300.png/09f/fff', 'https://via.placeholder.com/300.png/09f/fff', 'https://via.placeholder.com/300.png/09f/fff'];
          this.activeChart = 'utilization';

          if (history.state.log) {
            this.data = JSON.parse(history.state.log);
            this.output = JSON.parse(history.state.output); //console.log(this.data);
          } else {
        ...
        _createClass(ProjectDetailsComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.initiateUtilizationChart(); // $('[data-toggle="tooltip"]').tooltip();
          ...
          key: "calcPercentage",
          value: function calcPercentage(item) {
            var r = this.crud.calculatePercantage(item.actual, item.baseline, item.target, item.aggregation);
          ...
          key: "initiateUtilizationChart",
          value: function initiateUtilizationChart() {
            var _this5 = this;
            ...
            setTimeout(function () {
              _this5.utilizationChart = new chart_js__WEBPACK_IMPORTED_MODULE_0__["Chart"]('myUtilizationChart', {
                type: 'line',
                data: {
          ...
          key: "initiateBudgetChart",
          value: function initiateBudgetChart() {
            var _this6 = this;
            ...
            setTimeout(function () {
              _this6.budgetChart = new chart_js__WEBPACK_IMPORTED_MODULE_0__["Chart"]('myFinancialChart', {
                type: 'bar',
                data: {
                  labels: ['QTR-1', 'QTR-2', 'QTR-3', 'QTR-4'],
                  datasets: [{
          ...
          key: "getNumberOfDays",
          value: function getNumberOfDays(start_date) {
      ...
      ProjectDetailsComponent.ɵfac = function ProjectDetailsComponent_Factory(t) {
        return new (t || ProjectDetailsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_service_crud_service__WEBPACK_IMPORTED_MODULE_3__["CrudService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](ngx_bootstrap__WEBPACK_IMPORTED_MODULE_4__["BsModalService"]));
      };
      ...
      ProjectDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function ProjectDetailsComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ProjectDetailsComponent_Template_button_click_64_listener() {
              return ctx.initiateUtilizationChart();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ProjectDetailsComponent_Template_button_click_66_listener() {
              return ctx.initiateBudgetChart();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("pageChange", function ProjectDetailsComponent_Template_pagination_controls_pageChange_121_listener($event) {
              return ctx.p = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ProjectDetailsComponent_Template_button_click_144_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](146, "\xD7");
        ...
        pipes: [_suffixes_pipe__WEBPACK_IMPORTED_MODULE_9__["SuffixesPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["DecimalPipe"]],
    ...
    function QX6l(module, __webpack_exports__, __webpack_require__) {
      ...
      function DashboardComponent_img_44_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "img", 52);
        }
      }

      function DashboardComponent_img_45_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "img", 53);
        }
      }

      function DashboardComponent_img_49_Template(rf, ctx) {
        if (rf & 1) {
          var _r20 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "img", 54);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_49_Template_img_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r20);

            var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            return ctx_r19.mdasidebar = !ctx_r19.mdasidebar;
          });
      ...
      function DashboardComponent_img_50_Template(rf, ctx) {
        if (rf & 1) {
          var _r22 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "img", 55);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_50_Template_img_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r22);

            var ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            return ctx_r21.mdasidebar = !ctx_r21.mdasidebar;
          });
      ...
      function DashboardComponent_img_54_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_54_Template_img_click_0_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r24);

            var ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            return ctx_r23.gotoEsw();
          });
      ...
      function DashboardComponent_img_55_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_55_Template_img_click_0_listener() {
      ...
      function DashboardComponent_span_56_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_span_56_Template_span_click_0_listener() {
      ...
      function DashboardComponent_span_57_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_span_57_Template_span_click_0_listener() {
      ...
      function DashboardComponent_img_59_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_59_Template_img_click_0_listener() {
            ...
            ctx_r31.lightmode = !ctx_r31.lightmode;
            return ctx_r31.switchmode();
          });
      ...
      function DashboardComponent_img_60_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_60_Template_img_click_0_listener() {
            ...
            ctx_r33.lightmode = !ctx_r33.lightmode;
            return ctx_r33.switchmode();
          });
      ...
      function DashboardComponent_span_61_Template(rf, ctx) {
        if (rf & 1) {
          var _r36 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span", 32);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_span_61_Template_span_click_0_listener() {
            ...
            ctx_r35.lightmode = !ctx_r35.lightmode;
            return ctx_r35.switchmode();
          });
      ...
      function DashboardComponent_span_62_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_span_62_Template_span_click_0_listener() {
            ...
            ctx_r37.lightmode = !ctx_r37.lightmode;
            return ctx_r37.switchmode();
          });
      ...
      function DashboardComponent_img_64_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_64_Template_img_click_0_listener() {
      ...
      function DashboardComponent_img_65_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_65_Template_img_click_0_listener() {
      ...
      function DashboardComponent_img_69_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_69_Template_img_click_0_listener() {
            ...
            return ctx_r43.setactive = !ctx_r43.setactive;
          });
      ...
      function DashboardComponent_img_70_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_70_Template_img_click_0_listener() {
            ...
            return ctx_r45.setactive = !ctx_r45.setactive;
          });
      ...
      function DashboardComponent_img_74_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_74_Template_img_click_0_listener() {
      ...
      function DashboardComponent_img_75_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_img_75_Template_img_click_0_listener() {
      ...
      function DashboardComponent_div_79_li_4_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var item_r51 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function DashboardComponent_div_79_li_5_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li", 70);
      ...
      function DashboardComponent_div_79_li_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li", 70);
      ...
      function DashboardComponent_div_79_li_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li", 70);
      ...
      function DashboardComponent_div_79_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_div_79_Template_p_click_1_listener() {
            ...
            return ctx_r58.openMdaDashboard(item_r51.shortcode);
          });
      ...
      var DashboardComponent = /*#__PURE__*/function () {
        function DashboardComponent(route, crud, toastr, router) {
          ...
          var activeYear = localStorage.getItem('activeYear'); //console.log(activeYear);

          if (activeYear) this.activeYear = activeYear;
        }
        ...
        _createClass(DashboardComponent, [{
          ...
          key: "gotoEsw",
          value: function gotoEsw() {
            this.router.navigate(['/dashboard/early-warning']);
          }
        }, {
          key: "openMdaDashboard",
          value: function openMdaDashboard(id) {
            this.mdasidebar = false;
          ...
          key: "pullMdaByPerformance",
          value: function pullMdaByPerformance() {
            var _this7 = this;

            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        {\n          mdasByPerformance {\n          data\n          }\n        }\n      "])));
            this.crud.pullData(data, {}).subscribe(function (result) {
              _this7.mdas = JSON.parse(result.data["mdasByPerformance"].data); // this.assignCopy();
              // setInterval(() => {
              // 	// $('.usersTable').DataTable();
              // }, 2000);
            }, function (error) {// this.toastr.error("Oops, we could not get you user's data, please check your network and try again", "Unsuccessful")
            });
          }
        }, {
          key: "switchmode",
      ...
      DashboardComponent.ɵfac = function DashboardComponent_Factory(t) {
        return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_service_crud_service__WEBPACK_IMPORTED_MODULE_3__["CrudService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](ngx_toastr__WEBPACK_IMPORTED_MODULE_4__["ToastrService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
      };
      ...
      DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function DashboardComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function DashboardComponent_Template_form_ngSubmit_9_listener() {
              return ctx.onSearch();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function DashboardComponent_Template_input_ngModelChange_14_listener($event) {
              return ctx.search.query = $event;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_Template_a_click_23_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_Template_a_click_27_listener() {
              return ctx.logout();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_Template_img_click_40_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_Template_span_click_51_listener() {
              return ctx.mdasidebar = !ctx.mdasidebar;
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_Template_span_click_66_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardComponent_Template_span_click_76_listener() {
              return ctx.logout();
            });
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [_ngx_loading_bar_core__WEBPACK_IMPORTED_MODULE_1__["LoadingBarComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"]],
    ...
    /***/
    function Um58(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DashboardHomeOutcomeComponent", function () {
        return DashboardHomeOutcomeComponent;
      });
      /* harmony import */
      ...
      var _suffixes_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../suffixes.pipe */
      "WHRT");

      function DashboardHomeOutcomeComponent_section_0_div_1_p_7_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DashboardHomeOutcomeComponent_section_0_div_1_div_8_div_1_Template(rf, ctx) {
        if (rf & 1) {
          var _r10 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardHomeOutcomeComponent_section_0_div_1_div_8_div_1_Template_div_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r10);
            ...
            return ctx_r9.gotoOutcome(item_r7);
          });
        ...
        if (rf & 2) {
          ...
          var ind_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2).index;
      ...
      function DashboardHomeOutcomeComponent_section_0_div_1_div_8_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var p_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function DashboardHomeOutcomeComponent_section_0_div_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardHomeOutcomeComponent_section_0_div_1_Template_button_click_5_listener() {
            ...
            return ctx_r13.viewPriorityDetails(p_r2.id);
          });
      ...
      function DashboardHomeOutcomeComponent_section_0_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var DashboardHomeOutcomeComponent = /*#__PURE__*/function () {
        function DashboardHomeOutcomeComponent(crud, router) {
          _classCallCheck(this, DashboardHomeOutcomeComponent);
        ...
        _createClass(DashboardHomeOutcomeComponent, [{
          key: "finPoliciesByMdas",
          value: function finPoliciesByMdas(arg0) {
          ...
          key: "initializeGuage",
          value: function initializeGuage(data, id) {
            for (var i = 0; i < data.length; i++) {
              var currentGuage = document.getElementById(id + 'gauge' + i);
              var gauge = this.Gauge(currentGuage);
              var target = this.prepareTarget(data[i].target, 0).target;
              var percent = this.crud.calculatePercantage(data[i].actual, data[i].baseline, target, data[i].aggregation) / 100;
              gauge.value(percent);
            }
          }
        }, {
          ...
          value: function Gauge(el) {
            ...
            var setElement = function setElement(el) {
              ...
              if (_element2 != undefined) {
                data = _element2.querySelector(".gauge--data");
                needle = _element2.querySelector(".gauge--needle");
              }
            };
          ...
          key: "prepareTarget",
          value: function prepareTarget(data, index) {
            if (data == null) return [];
          ...
          key: "viewPriorityDetails",
          value: function viewPriorityDetails(p) {
          ...
          value: function setColor(data) {
            var target = this.prepareTarget(data.target, 0).target;
            var r = this.crud.calculatePercantage(parseFloat(data.actual), parseFloat(data.baseline), parseFloat(target), data.aggregation);
            this.priorities.forEach(function (e) {});
          ...
          value: function getPriorities() {
            ...
            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n    {\n      priorities(tree: 2){\n        id\n        title\n        order\n        lIndicators{\n            id\n            title\n            ref\n            type\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            mdaId\n            driver\n            \n          }\n        }\n      }\n  "])));
            this.crud.pullData(data, {}).subscribe(function (result) {
              _this8.priorities = result.data.priorities;

              for (var i = 0; i < _this8.priorities.length; i++) {
                _this8.initializeGuage(_this8.priorities[i].lIndicators, 'priority' + i);
              }
            });
          }
        }, {
          key: "gotoOutcome",
          value: function gotoOutcome(item) {
      ...
      DashboardHomeOutcomeComponent.ɵfac = function DashboardHomeOutcomeComponent_Factory(t) {
        return new (t || DashboardHomeOutcomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_service_crud_service__WEBPACK_IMPORTED_MODULE_2__["CrudService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
      };

      DashboardHomeOutcomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: DashboardHomeOutcomeComponent,
        selectors: [["app-dashboard-outcome-home"]],
        decls: 1,
        vars: 1,
        consts: [[4, "ngIf"], ["class", "container-fluid my-5 px-3", 4, "ngFor", "ngForOf"], [1, "container-fluid", "my-5", "px-3"], [1, "d-flex", "justify-content-between"], [1, "mb-4"], [1, "btn", "btn-sm", "btn-outline-warning", "mx-3", 3, "click"], ["style", "color: #ccc", "class", "text-center my-5", 4, "ngIf"], ["class", "d-flex horizontal-scroll", 4, "ngIf"], [1, "text-center", "my-5", 2, "color", "#ccc"], ["width", "20", "src", "assets/icons/box.svg", "alt", ""], [1, "d-flex", "horizontal-scroll"], ["class", "col-md-4 px-2", 4, "ngFor", "ngForOf"], [1, "col-md-4", "px-2"], [1, "primary-border", "text-center", "p-3", "cursor", 3, "click"], [1, "chart-small-label", 3, "title"], [1, "gauge", "gauge__liveupdate", "mt-3"], [1, "gauge--container"], [1, "gauge--marker"], [1, "gauge--background"], [1, "gauge--center"], [1, "gauge--data", 3, "ngStyle"], [1, "gauge--needle"], [1, "gauge--labels", "mdl-typography--headline"], [1, "gauge--label__low"], [1, "gauge--label__spacer", 2, "text-align", "center", "font-size", "1.5rem", 3, "ngStyle"], [1, "gauge--label__high"]],
        template: function DashboardHomeOutcomeComponent_Template(rf, ctx) {
          if (rf & 1) {
    ...
    /***/
    function WHRT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SuffixesPipe", function () {
        return SuffixesPipe;
      });
      /* harmony import */
      ...
      var SuffixesPipe = /*#__PURE__*/function () {
        function SuffixesPipe() {
          _classCallCheck(this, SuffixesPipe);
        }

        _createClass(SuffixesPipe, [{
          key: "transform",
      ...
      SuffixesPipe.ɵfac = function SuffixesPipe_Factory(t) {
        return new (t || SuffixesPipe)();
      };

      SuffixesPipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
        name: "suffix",
        type: SuffixesPipe,
        pure: true
      });
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var ngx_moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ngx-moment */
      "QUrN");
      /* harmony import */
      ...
      var _dashboard_home_dashboard_home_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./dashboard-home/dashboard-home.component */
      "lr2i");
      /* harmony import */


      var _all_outcomes_all_outcomes_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./all-outcomes/all-outcomes.component */
      "cQWv");
      /* harmony import */


      var _all_mandates_all_mandates_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./all-mandates/all-mandates.component */
      "N58W");
      /* harmony import */
      ...
      var _strategic_plan_strategic_plan_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./strategic-plan/strategic-plan.component */
      "nM3Y");
      /* harmony import */


      var _presidential_mandate_presidential_mandate_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./presidential-mandate/presidential-mandate.component */
      "7TvS");
      /* harmony import */


      var angular_2_dropdown_multiselect__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! angular-2-dropdown-multiselect */
      "HoCe");
      /* harmony import */
      ...
      var _mda_mda_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./mda/mda.component */
      "a3qC");
      /* harmony import */


      var ngx_bootstrap_tooltip__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ngx-bootstrap/tooltip */
      "Mfq2");
      /* harmony import */


      var _suffixes_pipe__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! ./suffixes.pipe */
      "WHRT");
      /* harmony import */
      ...
      var _account_user_login_user_login_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ./account/user-login/user-login.component */
      "6nnL");
      /* harmony import */


      var _graphql_module__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ./graphql.module */
      "4KHl");
      /* harmony import */
      ...
      var _guage_guage_guage_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
      /*! ./guage/guage/guage.component */
      "07TT");
      /* harmony import */


      var _settings_settings_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
      /*! ./settings/settings.component */
      "70H3");
      /* harmony import */


      var _user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
      /*! ./user-profile/user-profile.component */
      "/de2");
      /* harmony import */


      var _ews_ews_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
      /*! ./ews/ews.component */
      "CJl5");
      /* harmony import */


      var _project_details_project_details_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
      /*! ./project-details/project-details.component */
      "OVWj");
      /* harmony import */


      var _output_output_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
      /*! ./output/output.component */
      "z+Vf");
      /* harmony import */


      var _priority_priority_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
      /*! ./priority/priority.component */
      "pZjM");
      /* harmony import */


      var _project_details_photo_story_photo_story_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
      /*! ./project-details/photo-story/photo-story.component */
      "Lz8j");
      /* harmony import */


      var _dashboard_home1_dashboard_home_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
      /*! ./dashboard-home1/dashboard-home.component */
      "Um58");
      /* harmony import */


      var _dashboard_home2_dashboard_home_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
      /*! ./dashboard-home2/dashboard-home.component */
      "sHMU");
      /* harmony import */
      ...
      var ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
      /*! ngx-owl-carousel-o */
      "bhfF");
      /* harmony import */


      var _ngx_loading_bar_core__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
      /*! @ngx-loading-bar/core */
      "lPP5");
      /* harmony import */


      var _ngx_loading_bar_http_client__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
      /*! @ngx-loading-bar/http-client */
      "XJCJ");
      /* harmony import */


      var _ngx_loading_bar_router__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(
      /*! @ngx-loading-bar/router */
      "F34d");
      /* harmony import */


      var _search_search_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_40__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], ngx_bootstrap_accordion__WEBPACK_IMPORTED_MODULE_10__["AccordionModule"].forRoot(), angular_2_dropdown_multiselect__WEBPACK_IMPORTED_MODULE_14__["MultiselectDropdownModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_34__["ToastrModule"].forRoot(), ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_16__["ModalModule"].forRoot(), ngx_pagination__WEBPACK_IMPORTED_MODULE_4__["NgxPaginationModule"], ngx_bootstrap_tooltip__WEBPACK_IMPORTED_MODULE_18__["TooltipModule"].forRoot(), _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__["BrowserAnimationsModule"], ngx_bootstrap_popover__WEBPACK_IMPORTED_MODULE_20__["PopoverModule"].forRoot(), _graphql_module__WEBPACK_IMPORTED_MODULE_22__["GraphQLModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_23__["HttpClientModule"], ngx_moment__WEBPACK_IMPORTED_MODULE_0__["MomentModule"], ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_35__["CarouselModule"], _ngx_loading_bar_core__WEBPACK_IMPORTED_MODULE_36__["LoadingBarModule"], _ngx_loading_bar_http_client__WEBPACK_IMPORTED_MODULE_37__["LoadingBarHttpClientModule"], ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_15__["BsDropdownModule"].forRoot(), // for Router use:
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_40__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_6__["DashboardComponent"], _dashboard_home_dashboard_home_component__WEBPACK_IMPORTED_MODULE_7__["DashboardHomeComponent"], _dashboard_home1_dashboard_home_component__WEBPACK_IMPORTED_MODULE_32__["DashboardHomeOutcomeComponent"], _dashboard_home2_dashboard_home_component__WEBPACK_IMPORTED_MODULE_33__["DashboardOutputHomeComponent"], _all_outcomes_all_outcomes_component__WEBPACK_IMPORTED_MODULE_8__["AllOutcomesComponent"], _all_mandates_all_mandates_component__WEBPACK_IMPORTED_MODULE_9__["AllMandatesComponent"], _strategic_plan_strategic_plan_component__WEBPACK_IMPORTED_MODULE_12__["StrategicPlanComponent"], _presidential_mandate_presidential_mandate_component__WEBPACK_IMPORTED_MODULE_13__["PresidentialMandateComponent"], _mda_mda_component__WEBPACK_IMPORTED_MODULE_17__["MdaComponent"], _suffixes_pipe__WEBPACK_IMPORTED_MODULE_19__["SuffixesPipe"], _account_user_login_user_login_component__WEBPACK_IMPORTED_MODULE_21__["UserLoginComponent"], _guage_guage_guage_component__WEBPACK_IMPORTED_MODULE_24__["GuageComponent"], _settings_settings_component__WEBPACK_IMPORTED_MODULE_25__["SettingsComponent"], _user_profile_user_profile_component__WEBPACK_IMPORTED_MODULE_26__["UserProfileComponent"], _ews_ews_component__WEBPACK_IMPORTED_MODULE_27__["EwsComponent"], _project_details_project_details_component__WEBPACK_IMPORTED_MODULE_28__["ProjectDetailsComponent"], _output_output_component__WEBPACK_IMPORTED_MODULE_29__["OutputComponent"], _priority_priority_component__WEBPACK_IMPORTED_MODULE_30__["PriorityComponent"], _project_details_photo_story_photo_story_component__WEBPACK_IMPORTED_MODULE_31__["PhotoStoryComponent"], _search_search_component__WEBPACK_IMPORTED_MODULE_39__["SearchComponent"]],
          imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], ngx_bootstrap_accordion__WEBPACK_IMPORTED_MODULE_10__["AccordionModule"], angular_2_dropdown_multiselect__WEBPACK_IMPORTED_MODULE_14__["MultiselectDropdownModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], ngx_toastr__WEBPACK_IMPORTED_MODULE_34__["ToastrModule"], ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_16__["ModalModule"], ngx_pagination__WEBPACK_IMPORTED_MODULE_4__["NgxPaginationModule"], ngx_bootstrap_tooltip__WEBPACK_IMPORTED_MODULE_18__["TooltipModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__["BrowserAnimationsModule"], ngx_bootstrap_popover__WEBPACK_IMPORTED_MODULE_20__["PopoverModule"], _graphql_module__WEBPACK_IMPORTED_MODULE_22__["GraphQLModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_23__["HttpClientModule"], ngx_moment__WEBPACK_IMPORTED_MODULE_0__["MomentModule"], ngx_owl_carousel_o__WEBPACK_IMPORTED_MODULE_35__["CarouselModule"], _ngx_loading_bar_core__WEBPACK_IMPORTED_MODULE_36__["LoadingBarModule"], _ngx_loading_bar_http_client__WEBPACK_IMPORTED_MODULE_37__["LoadingBarHttpClientModule"], ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_15__["BsDropdownModule"], // for Router use:
          _ngx_loading_bar_router__WEBPACK_IMPORTED_MODULE_38__["LoadingBarRouterModule"]]
        });
      })();
      /***/
    ...
    /***/
    function a3qC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MdaComponent", function () {
        return MdaComponent;
      });
      /* harmony import */


      var _sp_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./sp.json */
      "3dTk");

      var _sp_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(
      /*! ./sp.json */
      "3dTk", 1);
      /* harmony import */
      ...
      var ngx_bootstrap_popover__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ngx-bootstrap/popover */
      "EDFS");
      /* harmony import */
      ...
      var _suffixes_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../suffixes.pipe */
      "WHRT");

      function MdaComponent_span_7_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function MdaComponent_span_8_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
      ...
      function MdaComponent_span_9_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
      ...
      function MdaComponent_span_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
      ...
      function MdaComponent_ng_template_11_li_3_Template(rf, ctx) {
        if (rf & 1) {
          var _r12 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li", 62);

          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_ng_template_11_li_3_Template_li_click_0_listener() {
            ...
            return ctx_r11.changeView(item_r10.id);
          });
      ...
      function MdaComponent_ng_template_11_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function MdaComponent_li_50_span_20_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
      ...
      function MdaComponent_li_50_span_24_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
      ...
      function MdaComponent_li_50_span_28_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
      ...
      function MdaComponent_li_50_ul_34_li_1_ul_17_li_1_span_23_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function MdaComponent_li_50_ul_34_li_1_ul_17_li_1_span_33_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function MdaComponent_li_50_ul_34_li_1_ul_17_li_1_ul_38_li_1_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var project_r30 = ctx.$implicit;

          var indicator_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2).$implicit;

          var ctx_r29 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](5);
      ...
      function MdaComponent_li_50_ul_34_li_1_ul_17_li_1_ul_38_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var indicator_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function MdaComponent_li_50_ul_34_li_1_ul_17_li_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li", 65);
        ...
        if (rf & 2) {
          var indicator_r24 = ctx.$implicit;
          var i_r25 = ctx.index;
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" Baseline \xBB ", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](22, 10, indicator_r24.baseline), "");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" Targets \xBB ", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](26, 12, indicator_r24.target), "");
      ...
      function MdaComponent_li_50_ul_34_li_1_ul_17_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ul");
        ...
        if (rf & 2) {
          var mandate_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function MdaComponent_li_50_ul_34_li_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li", 65);
      ...
      function MdaComponent_li_50_ul_34_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ul");
        ...
        if (rf & 2) {
          var priority_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function MdaComponent_li_50_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](16, "\xA0");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](19, " Baseline \xBB ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](23, " Targets \xBB ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](33, "\xA0");
      ...
      var MdaComponent = /*#__PURE__*/function () {
        function MdaComponent(data, modalService) {
          _classCallCheck(this, MdaComponent);
        ...
        _createClass(MdaComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this9 = this;

            this.data.currentMessage.subscribe(function (message) {
              return _this9.mandateId = message;
            }); // this.openModal()
          ...
          value: function getIndicatorValue(ind) {
            var value = 0;
            ind.projects.forEach(function (element) {
              value += parseInt(element.drs[element.drs.length - 1].output); // //console.log(parseInt(element.drs[element.drs.length - 1].output));

              if (ind.projects[ind.projects.length - 1] == element) {// //console.log(value);
              }
            });
            return value;
          }
          ...
          key: "filterData",
          value: function filterData(id) {
            var prorityToFilter = JSON.parse(localStorage.getItem('mdapriorities'));
            var priorities = [];
            this.mandates = [];
            ...
            prorityToFilter.forEach(function (element) {
              if (element.mandates) {
                var mandate = element.mandates.filter(function (el) {
                  return el.mdas.includes(id);
                });
      ...
      MdaComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function MdaComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](35, " Baseline \xBB 0");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](36, "br");

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](37, " Actual \xBB 0");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_small_click_118_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);

              var _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](236);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_small_click_125_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_small_click_137_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_small_click_149_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_small_click_161_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_small_click_185_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_small_click_192_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_small_click_204_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_small_click_216_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_small_click_228_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_button_click_242_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](244, "\xD7");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_span_click_252_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);

              var _r8 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](265);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_span_click_257_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_span_click_262_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function MdaComponent_Template_button_click_271_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r36);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](273, "\xD7");
    ...
    /***/
    function cQWv(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AllOutcomesComponent", function () {
        return AllOutcomesComponent;
      });
      /* harmony import */
      ...
      var _states_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./states.json */
      "vumz");

      var _states_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(
      /*! ./states.json */
      "vumz", 1);
      /* harmony import */
      ...
      var _suffixes_pipe__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ../suffixes.pipe */
      "WHRT");
      /* harmony import */


      var ngx_moment__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ngx-moment */
      "QUrN");

      function AllOutcomesComponent_div_0_div_5_span_13_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AllOutcomesComponent_div_0_div_5_span_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span");
      ...
      function AllOutcomesComponent_div_0_div_5_span_18_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span");
      ...
      function AllOutcomesComponent_div_0_div_5_span_21_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span");
      ...
      function AllOutcomesComponent_div_0_div_5_span_23_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span");
      ...
      function AllOutcomesComponent_div_0_div_5_span_26_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span");
      ...
      function AllOutcomesComponent_div_0_div_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AllOutcomesComponent_div_0_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AllOutcomesComponent_div_29_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_ul_53_li_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AllOutcomesComponent_li_33_accordion_group_1_ul_53_li_1_Template_a_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r26);

            var item_r24 = ctx.$implicit;

            var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](4);

            return ctx_r25.filterByMda(item_r24);
          });
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_ul_53_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_ul_58_li_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AllOutcomesComponent_li_33_accordion_group_1_ul_58_li_1_Template_a_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r30);

            var item_r28 = ctx.$implicit;

            var ctx_r29 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](4);

            return ctx_r29.filterByState(item_r28.state);
          });
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_ul_58_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "ul", 78);
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_p_63_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_table_64_tr_20_span_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span");
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_table_64_tr_20_span_5_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span");
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_table_64_tr_20_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AllOutcomesComponent_li_33_accordion_group_1_table_64_tr_20_Template_em_click_23_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r38);

            var item_r32 = ctx.$implicit;

            var ind_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](3).$implicit;

            var ctx_r36 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]();

            return ctx_r36.openProjectReports(item_r32, ind_r13);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](25, " \xA0 ");
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_table_64_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var ind_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](2).$implicit;
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_pagination_controls_65_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("pageChange", function AllOutcomesComponent_li_33_accordion_group_1_pagination_controls_65_Template_pagination_controls_pageChange_0_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r41);

            var ctx_r40 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](3);

            return ctx_r40.p = $event;
          });
      ...
      function AllOutcomesComponent_li_33_accordion_group_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](39, " \xA0 \xA0 ");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AllOutcomesComponent_li_33_accordion_group_1_Template_a_click_60_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r44);

            var ind_r13 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]().$implicit;
      ...
      function AllOutcomesComponent_li_33_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function AllOutcomesComponent_div_34_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var AllOutcomesComponent = /*#__PURE__*/function () {
        function AllOutcomesComponent(data, crud, router) {
          _classCallCheck(this, AllOutcomesComponent);
        ...
        _createClass(AllOutcomesComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this10 = this;

            // this.setFilteredItems("");
            this.searchControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["debounceTime"])(100)).subscribe(function (search) {
              // this.search(search);
              _this10.setFilteredItems(search, _this10.currentProject);
            });
            this.filterOutcome();
          ...
          key: "initializeGuage",
          value: function initializeGuage(data) {
            var currentGuage = document.getElementsByClassName('gauge');

            for (var i = 0; i < data.length; i++) {
              var gauge = this.Gauge(currentGuage[i]);
              var target = this.prepareTarget(data[i].target, 0).target;
              var percent = this.crud.calculatePercantage(data[i].actual, data[i].baseline, target, data[i].aggregation) / 100;
              gauge.value(percent);
            }
          ...
          key: "filterOutcome",
          value: function filterOutcome() {
            var _this11 = this;

            //console.log(this.outComeData.outputs);
            this.outComeData.outputs.forEach(function (element) {
              var percent = _this11.crud.calculatePercantage(element.actual, element.baseline, element.target, element.aggregation); //console.log(percent);


              if (percent <= 33.3) {
                _this11.counts.low += 1;
              }

              if (percent > 33.3 && percent <= 66.6) {
                _this11.counts.mid += 1;
              }

              if (percent > 66.6) {
                _this11.counts.high += 1;
              }
            });
          }
        }, {
          ...
          value: function Gauge(el) {
            ...
            var setElement = function setElement(el) {
              // Keep a reference to the various elements and sub-elements
              _element3 = el;
              data = _element3.querySelector(".gauge--data");
              needle = _element3.querySelector(".gauge--needle");
            };
          ...
          key: "getPercentage",
          value: function getPercentage(actual, baseline, target, aggr) {
            var percentage = this.crud.calculatePercantage(actual, baseline, this.prepareTarget(target, 0).target, aggr);
            return percentage;
          }
        }, {
          key: "setColor",
          value: function setColor(data) {
            this.initializeGuage(this.indicator);
            var target = this.prepareTarget(data.target, 0).target;
            var r = this.crud.calculatePercantage(parseFloat(data.actual), parseFloat(data.baseline), parseFloat(target), data.aggregation); // console.log(r);
          ...
          key: "calcPercentage",
          value: function calcPercentage(a, b) {
            var percent = a / b * 100;
          ...
          key: "gotoOutput",
          value: function gotoOutput(item) {
            //console.log(item);
            var itemObj = {
          ...
          key: "filterByState",
          value: function filterByState(state) {
            this.stateFilter = state.name;
            if (state == '') this.assignCopy(this.currentProject);
            this.filteredItems = this.filteredItems.filter(function (item) {
              return item.state == state.name; // //console.log(item.state, state.name);
            });
          }
        }, {
          key: "filterByMda",
          value: function filterByMda(mda) {
            this.mdaFilter = mda.shortcode;
            if (mda == '') this.assignCopy(this.currentProject);
            this.filteredItems = this.filteredItems.filter(function (item) {
              return item.mda.id == mda.id; // //console.log(item.state, state.name);
            });
          }
        }, {
          key: "assignCopy",
          value: function assignCopy(project) {
            this.currentProject = project;
            this.filteredItems = this.currentProject;
          }
        }, {
          key: "setFilteredItems",
          value: function setFilteredItems(search, projects) {
            //console.log(search);
            if (search == '') this.assignCopy(projects);
            this.filteredItems = this.filteredItems.filter(function (item) {
          ...
          key: "clearFilters",
          value: function clearFilters(projects) {
          ...
          key: "openProjectReports",
          value: function openProjectReports(item, ind) {
    ...
    /***/
    function lr2i(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _dashboard_home1_dashboard_home_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../dashboard-home1/dashboard-home.component */
      "Um58");

      var DashboardHomeComponent = /*#__PURE__*/function () {
        function DashboardHomeComponent(crud, router) {
          ...
          this.budgetPriority = false;
          this.priorities = JSON.parse(localStorage.getItem('preffered')); // this.getPriorities();
        }
        ...
        _createClass(DashboardHomeComponent, [{
          ...
          key: "ngOnInit",
          value: function ngOnInit() {// let pref = JSON.parse(localStorage.getItem('preffered'))
            // if (pref != undefined) this.preffered = pref
          }
        }, {
          key: "changeActive",
          value: function changeActive(text) {
      ...
      DashboardHomeComponent.ɵfac = function DashboardHomeComponent_Factory(t) {
        return new (t || DashboardHomeComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_service_crud_service__WEBPACK_IMPORTED_MODULE_1__["CrudService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
      };

      DashboardHomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [_dashboard_home1_dashboard_home_component__WEBPACK_IMPORTED_MODULE_3__["DashboardHomeOutcomeComponent"]],
    ...
    /***/
    function nM3Y(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "StrategicPlanComponent", function () {
        return StrategicPlanComponent;
      });
      /* harmony import */
      ...
      var _suffixes_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../suffixes.pipe */
      "WHRT");

      function StrategicPlanComponent_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function StrategicPlanComponent_div_15_div_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StrategicPlanComponent_div_15_div_2_Template_div_click_1_listener() {
            ...
            return ctx_r6.gotoOutcome(item_r4);
          });
      ...
      function StrategicPlanComponent_div_15_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StrategicPlanComponent_div_15_Template_button_click_3_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r9);

            var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            return ctx_r8.scrollElementPrev();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StrategicPlanComponent_div_15_Template_button_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r9);

            var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            return ctx_r10.scrollElementNext();
          });
      ...
      function StrategicPlanComponent_div_56_div_6_div_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 66);
        ...
        if (rf & 2) {
          var man_r14 = ctx.$implicit;

          var ind_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function StrategicPlanComponent_div_56_div_6_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StrategicPlanComponent_div_56_div_6_Template_div_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18);

            var ind_r12 = ctx.$implicit;

            var ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

            return ctx_r17.gotoOutput(ind_r12);
          });
      ...
      function StrategicPlanComponent_div_56_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      var StrategicPlanComponent = /*#__PURE__*/function () {
        function StrategicPlanComponent(data, crudService, router, route) {
          var _this12 = this;

          _classCallCheck(this, StrategicPlanComponent);
          ...
          this.activeYear = '2020';
          this.col = 0; // this.changeView();

          this.getMda();
          this.router.params.subscribe(function (params) {
            _this12.shortCode = params.data;
          });
          var activeYear = localStorage.getItem('activeYear');
          if (activeYear) this.activeYear = activeYear;
        }

        _createClass(StrategicPlanComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this13 = this;

            this.data.currentMessage.subscribe(function (message) {
              return _this13.mandateId = message;
            });
            setTimeout(function () {
              _this13.initiateChart();
            }, 2000);
            this.initiateBudgetChart();
            setInterval(function () {
              _this13.scrollElementNext();
            }, 5000);
          }
        }, {
          key: "getMdaId",
          value: function getMdaId() {
            var _this14 = this;

            this.mdaId = this.ministries.filter(function (el) {
              return el.shortcode === _this14.shortCode;
            });
            this.getIndicator();
          }
        }, {
          ...
          key: "initiateChartInterativity",
          value: function initiateChartInterativity(evt, array) {
            ...
            this.testBudgetChart.update(); // document.getElementById('replaceDataObject').addEventListener('click', function() {
            //   var newDataObject = {
          ...
          key: "initiatePriorityChart",
          value: function initiatePriorityChart() {
            var _this15 = this;
            ...
            setTimeout(function () {
              _this15.priorityChart = new Chart('myPriorityChart', {
                type: 'bar',
                data: {
                ...
                options: {
                  onClick: _this15.initiateChartInterativity.bind(_this15),
                  responsive: true,
                  scaleFontColor: "#FFFFFF",
                  legend: {
                    display: false,
            ...
            }, 200); // this.budgetCanvas = document.getElementById('myChart9');
          ...
          value: function initiateBudgetChart() {
            ...
            // }
            setTimeout(function () {
              _this16.budgetChart = new Chart('myBudgetChart', {
                type: 'bar',
                data: {
          ...
          key: "getMda",
          value: function getMda() {
            var _this17 = this;

            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n      {\n        mdas{\n          id\n          name\n          shortcode\n        }\n      }\n    "])));
            this.crudService.pullData(data, {}).subscribe(function (result) {
              _this17.ministries = result.data.mdas;
          ...
          value: function getIndicator() {
            ...
            var query = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n      query indicatorsByMda($mdaId: ID!){\n        indicatorsByMda(mdaId: $mdaId){\n          id\n          title\n          driver\n          datasource\n          type\n          ref\n          unitType\n          unit\n          baseline\n          actual\n          target\n          aggregation\n          rt\n          currency\n          score\n          active\n          mdaId\n          priorityId\n          outputs{\n            id\n            title\n            ref\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            type\n            unit\n            unitType\n            mdaId\n            mandates{\n              id\n              title\n            },\n            datasource\n            projects{\n              id\n              puid\n              title\n              ref\n              budget\n              cost\n              type\n              start_date\n              end_date\n              status\n              state\n              lga\n              currency\n              score\n              active\n            }\n          }\n          jobs{\n           id\n           title\n           ref\n           baseline\n           actual\n           target\n           aggregation\n           rt\n           currency\n           active\n           type\n            unit\n            unitType\n           mdaId\n           mandates{\n             id\n             title\n           }\n           datasource\n\n         }\n         gender{\n           id\n           title\n           ref\n           baseline\n           actual\n           target\n           aggregation\n           rt\n           currency\n           active\n           type\n            unit\n            unitType\n           mdaId\n           mandates{\n             id\n             title\n           }\n           datasource\n          }\n        }\n      }\n    "])));
            this.crudService.pullData(query, {
              mdaId: this.mdaId[0].id
            }).subscribe(function (res) {
              _this18.indicator = res.data.indicatorsByMda;
              console.log(_this18.indicator);
              _this18.drive1 = _this18.indicator.filter(function (e) {
                return e.driver == "Increase Agricultural production while deploying productivity improvement measures";
              });
              _this18.drive2 = _this18.indicator.filter(function (e) {
                return e.driver == "Deepen/Broaden the Agricultural chain through value addition";
              });
              _this18.drive3 = _this18.indicator.filter(function (e) {
                return e.driver == "Ensure Affodability of Staple Foods";
              });
              var output = [];

              _this18.indicator.forEach(function (e) {
                if (e.outputs.length > 0) {
                  output = output.concat(e.outputs);
                }
              });

              _this18.output = output;
              console.log(_this18.output);

              _this18.initializeGuage(_this18.indicator);
          ...
          value: function getBudget() {
            var query = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n      query budgetByMDAYear($mdaId: ID!, $year: String!){\n        budgetByMDAYear(mdaId: $mdaId, year: $year){\n          id\n          budget_line_item\n          budget_code\n          amount\n          year\n        }\n      }\n    "])));
            this.crudService.pullData(query, {
              mdaId: this.mdaId[0].id,
          ...
          value: function initializeGuage(data) {
            ...
            for (var i = 0; i < data.length; i++) {
              var gauge = this.Gauge(currentGuage[i]);
              var target = this.prepareTarget(data[i].target, 0).target;
              var percent = this.crudService.calculatePercantage(data[i].actual, data[i].baseline, target, data[i].aggregation) / 100;
              gauge.value(percent);
            }
          }
        }, {
          ...
          value: function Gauge(el) {
            ...
            var setElement = function setElement(el) {
              ...
              if (_element4 != undefined) {
                data = _element4.querySelector(".gauge--data");
                needle = _element4.querySelector(".gauge--needle");
              }
            };
          ...
          key: "setColor",
          value: function setColor(data) {
            var target = this.prepareTarget(data.target, 0).target; // tslint:disable-next-line:max-line-length

            var r = this.crudService.calculatePercantage(parseFloat(data.actual), parseFloat(data.baseline), parseFloat(target), data.aggregation);
            this.initializeGuage(this.indicator);
          ...
          key: "scrollElementNext",
          value: function scrollElementNext() {
            var el = document.querySelector('.horizontal-scroll');
          ...
          key: "scrollElementPrev",
          value: function scrollElementPrev() {
            var el = document.querySelector('.horizontal-scroll');
      ...
      StrategicPlanComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        template: function StrategicPlanComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StrategicPlanComponent_Template_button_click_68_listener() {
              return ctx.activeImp = "Project";
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StrategicPlanComponent_Template_button_click_70_listener() {
              return ctx.activeImp = "Policy";
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function StrategicPlanComponent_Template_button_click_72_listener() {
              return ctx.activeImp = "Programmes";
            });
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], ngx_bootstrap_tooltip__WEBPACK_IMPORTED_MODULE_6__["TooltipDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgStyle"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgClass"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"]],
        pipes: [_suffixes_pipe__WEBPACK_IMPORTED_MODULE_7__["SuffixesPipe"]],
    ...
    /***/
    function nmJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function pZjM(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PriorityComponent", function () {
      ...
      var _suffixes_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../suffixes.pipe */
      "WHRT");

      function PriorityComponent_a_8_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function PriorityComponent_a_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function PriorityComponent_div_10_div_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PriorityComponent_div_10_div_2_Template_div_click_1_listener() {
            ...
            return ctx_r10.gotoOutcome(item_r8);
          });
      ...
      function PriorityComponent_div_10_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PriorityComponent_div_10_Template_button_click_3_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r13);

            var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            return ctx_r12.scrollElementPrev();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PriorityComponent_div_10_Template_button_click_5_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r13);

            var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            return ctx_r14.scrollElementNext();
          });
      ...
      function PriorityComponent_div_11_div_6_div_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 45);
        ...
        if (rf & 2) {
          var man_r18 = ctx.$implicit;

          var ind_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function PriorityComponent_div_11_div_6_Template(rf, ctx) {
        if (rf & 1) {
          var _r22 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PriorityComponent_div_11_div_6_Template_div_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r22);

            var ind_r16 = ctx.$implicit;

            var ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

            return ctx_r21.gotoOutput(ind_r16);
          });
      ...
      function PriorityComponent_div_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
      ...
      function PriorityComponent_li_23_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li", 54);
      ...
      function PriorityComponent_li_29_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li", 54);
      ...
      function PriorityComponent_li_37_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "li", 54);
      ...
      var PriorityComponent = /*#__PURE__*/function () {
        function PriorityComponent(crud, activeRoute, router) {
          _classCallCheck(this, PriorityComponent);
        ...
        _createClass(PriorityComponent, [{
          key: "finPoliciesByMdas",
          value: function finPoliciesByMdas(arg0) {
            throw new Error("Method not implemented.");
          }
          ...
          value: function ngOnInit() {
            ...
            this.activeRoute.paramMap.subscribe(function (param) {
              ...
              _this19.pullDataByPriority(param.params.id);
            }); // this.getIndicator();
            // let pref = JSON.parse(localStorage.getItem('preffered'));
            // if (pref != undefined) this.preffered = pref;

            var d = new Date();
            var date = d.getDate(); // var month = d.getMonth() + 1; // Since getMonth() returns month from 0-11 not 1-12
          ...
          key: "pullDataByPriority",
          value: function pullDataByPriority(id) {
            var _this20 = this;

            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n     query priority(\n        $id: ID!\n    ){\n      priority(id: $id) {\n           id\n        title\n        order\n        lIndicators{\n            id\n            title\n            ref\n            type\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            mdaId\n            driver\n            outputs{\n              id\n              title\n              ref\n              baseline\n              actual\n              target\n              aggregation\n              rt\n              currency\n              active\n              mdaId\n              mda{\n                id\n                name\n                shortcode\n              }\n              projects{\n                id\n                puid\n                title\n                ref\n                budget\n                type\n                images\n                start_date\n                end_date\n                status\n                state\n                lga\n                currency\n                active\n                userId\n                logframes{\n                  id\n                  comments\n                  challenges\n                  outputValue\n                  longitude\n                  latitude\n                  images\n                  status\n                  qow\n                  loc\n                  type\n                  budget\n                  approved\n                  released\n                  utilized\n                  logframeStatus\n                  project{\n                    id\n                    title\n                  }\n\n                 }\n\n                mda{\n                  id\n                  name\n                  shortcode\n                }\n              }\n              mandates{\n              id\n              title\n            }\n            }\n          }\n          \n        }\n    }\n    \n  \n    "])));
            this.crud.pullData(data, {
              id: id
            }).subscribe(function (result) {
              // this.currentPriorities = ''
              _this20.priority = result.data['priority'];

              _this20.priority.lIndicators.forEach(function (e) {
                //   // tslint:disable-next-line:curly
                if (e.outputs.length > 0) {
                  _this20.output = _this20.output.concat(e.outputs);
                }
              });

              _this20.initializeGuage(_this20.priority.lIndicators);

              setInterval(function () {
                _this20.scrollElementNext();
              }, 5000); // this.temp = result.data.priorities;
              // localStorage.setItem('priorities', JSON.stringify(this.priorities))
              // this.openModal()
            });
          }
          ...
          value: function Gauge(el) {
            ...
            var setElement = function setElement(el) {
              ...
              if (_element5 != undefined) {
                data = _element5.querySelector(".gauge--data");
                needle = _element5.querySelector(".gauge--needle");
              }
            };
          ...
          key: "getPercentage",
          value: function getPercentage(data) {
            var percentage = 0;
          ...
          key: "getMdas",
          value: function getMdas() {
            var _this21 = this;

            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n    {\n      mdas{\n        id\n        name\n        indicators{\n            id\n            title\n            ref\n            type\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            mdaId\n          }\n          outputs{\n            id\n            title\n            ref\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            mdaId\n          }\n        }\n      }\n  "])));
            this.crud.pullData(data, {}).subscribe(function (result) {
              // this.currentPriorities = ''
              _this21.mdas = result.data.mdas; // this.temp = result.data.priorities;
              // localStorage.setItem('priorities', JSON.stringify(this.priorities))
              // this.openModal()
            });
          }
          ...
          key: "prepareCurrentTarget",
          value: function prepareCurrentTarget(data) {
            var _this22 = this;

            // console.log(data);
            if (data == null) return [];
            var pre = JSON.parse(data);
            var rdata; // if (index == null) {

            pre.forEach(function (element) {
              if (element.year == _this22.activeYear) rdata = element;
            }); // console.log(rdata);
      ...
      PriorityComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgStyle"], ngx_bootstrap_tooltip__WEBPACK_IMPORTED_MODULE_5__["TooltipDirective"]],
        pipes: [_suffixes_pipe__WEBPACK_IMPORTED_MODULE_6__["SuffixesPipe"]],
    ...
    /***/
    function sHMU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DashboardOutputHomeComponent", function () {
        return DashboardOutputHomeComponent;
      });
      /* harmony import */
      ...
      function DashboardOutputHomeComponent_6_ng_template_0_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 25);
      ...
      function DashboardOutputHomeComponent_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DashboardOutputHomeComponent_owl_carousel_o_55_ng_container_1_ng_template_1_div_4_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardOutputHomeComponent_owl_carousel_o_55_ng_container_1_ng_template_1_div_4_Template_small_click_1_listener() {
            ...
            return ctx_r14.gotoOutcome(i_r13);
          });
      ...
      function DashboardOutputHomeComponent_owl_carousel_o_55_ng_container_1_ng_template_1_Template(rf, ctx) {
        if (rf & 1) {
          var _r18 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DashboardOutputHomeComponent_owl_carousel_o_55_ng_container_1_ng_template_1_Template_h6_click_2_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r18);

            var p_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;

            var ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

            return ctx_r16.viewPriorityDetails(p_r9);
          });
      ...
      function DashboardOutputHomeComponent_owl_carousel_o_55_ng_container_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DashboardOutputHomeComponent_owl_carousel_o_55_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DashboardOutputHomeComponent_div_61_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function DashboardOutputHomeComponent_div_67_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 46);
      ...
      var DashboardOutputHomeComponent = /*#__PURE__*/function () {
        function DashboardOutputHomeComponent(crud, router) {
          _classCallCheck(this, DashboardOutputHomeComponent);
          ...
          this.activeChart = 'priority';
          this.budgetPriority = false;
          var indicators = JSON.parse(localStorage.getItem('preffered'));
          if (indicators) this.indicator = indicators;
          this.getPriorities();
          this.initiateCarousel();
        }

        _createClass(DashboardOutputHomeComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            // this.initiatePriorityChart();
            this.initiateBudgetChart();
            this.pullFinancials();
            this.getMdas(); // this.pullfinProductsByMdas();
          ...
          value: function Gauge(el) {
            ...
            var setElement = function setElement(el) {
              ...
              if (_element6 !== undefined) {
                data = _element6.querySelector(".gauge--data");
                needle = _element6.querySelector(".gauge--needle");
              }
            };
          ...
          value: function initiatePriorityChart() {
            ...
            setTimeout(function () {
              _this23.priorityChart = new Chart('myPriorityChart', {
                type: 'bar',
                data: {
                  labels: ['Priority 1', 'Priority 2', 'Priority 3', 'Priority 4', 'Priority 5', 'Priority 6', 'Priority 7', 'Priority 8', 'Priority 9'],
                  datasets: [{
                ...
                options: {
                  onClick: _this23.initiateChartInterativity.bind(_this23),
                  responsive: true,
                  scaleFontColor: "#FFFFFF",
                  legend: {
                    display: false,
          ...
          key: "pullFinancials",
          value: function pullFinancials() {
            var _this24 = this;

            // console.log('pulling');
            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["\n        {\n          financials {\n          data\n\n          }\n        }\n      "])));
            this.crud.pullData(data, {}).subscribe(function (result) {
              _this24.financials = JSON.parse(result.data["financials"].data); // this.assignCopy();
              // setInterval(() => {
              // 	// $('.usersTable').DataTable();
              // }, 2000);
          ...
          key: "pullfinProductsByMdas",
          value: function pullfinProductsByMdas() {
            var _this25 = this;

            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n        {\n          finProjectsByMdas {\n          data\n          }\n        }\n      "])));
            this.crud.pullData(data, {}).subscribe(function (result) {
              _this25.finProjectsByMdas = JSON.parse(result.data["finProjectsByMdas"].data); // this.assignCopy();
              // setInterval(() => {
              // 	// $('.usersTable').DataTable();
              // }, 2000);
          ...
          key: "pullfinPoliciesByMdas",
          value: function pullfinPoliciesByMdas() {
            var _this26 = this;

            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["\n        {\n          finPoliciesByMdas {\n          data\n          }\n        }\n      "])));
            this.crud.pullData(data, {}).subscribe(function (result) {
              _this26.finPoliciesByMdas = JSON.parse(result.data["finPoliciesByMdas"].data); // this.assignCopy();
              // setInterval(() => {
              // 	// $('.usersTable').DataTable();
              // }, 2000);
          ...
          value: function getMdas() {
            ...
            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["\n    {\n      mdas{\n        id\n        name\n        indicators{\n            id\n            title\n            ref\n            type\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            mdaId\n            outputs{\n            id\n            title\n            ref\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            mda{\n              id\n              name\n              shortcode\n            }\n          }\n          }\n        }\n      }\n  "])));
            this.crud.pullData(data, {}).subscribe(function (result) {
              // this.currentPriorities = ''
              _this27.mdas = result.data.mdas; // for (let el of this.mdas) {
          ...
          value: function getPriorities() {
            ...
            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n    {\n      priorities{\n        id\n        title\n        order\n        indicators{\n            id\n            title\n            ref\n            type\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            mdaId\n            driver\n            outputs{\n              id\n              title\n              ref\n              baseline\n              actual\n              target\n              aggregation\n              rt\n              currency\n              active\n              mdaId\n              mda{\n                id\n                name\n                shortcode\n              }\n              projects{\n                id\n                puid\n                title\n                ref\n                budget\n                type\n                start_date\n                end_date\n                status\n                state\n                lga\n                currency\n                active\n                userId\n                logframes{\n                  id\n                  comments\n                  challenges\n                  outputValue\n                  longitude\n                  latitude\n                  images\n                  status\n                  qow\n                  loc\n                  type\n                  budget\n                  approved\n                  released\n                  utilized\n                  logframeStatus\n                  project{\n                    id\n                    title\n                  }\n\n                 }\n\n                mda{\n                  id\n                  name\n                  shortcode\n                }\n              }\n              mandates{\n              id\n              title\n            }\n            }\n          }\n        }\n      }\n\n\n  "])));
            this.crud.pullData(data, {}).subscribe(function (result) {
              _this28.priorities = result.data.priorities;
            });
          }
        }, {
          key: "gotoOutcome",
    ...
    function tq2C(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_service_crud_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! src/app/service/crud.service */
      "+JMX");
      /* harmony import */
      ...
      function SearchComponent_div_14_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("change", function SearchComponent_div_14_Template_input_change_1_listener($event) {
            ...
            return ctx_r4.filter($event, type_r3);
          });
      ...
      function SearchComponent_span_18_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SearchComponent_div_19_span_8_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
      ...
      function SearchComponent_div_19_span_9_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "span");
      ...
      function SearchComponent_div_19_div_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 25);
      ...
      function SearchComponent_div_19_div_11_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 25);
      ...
      function SearchComponent_div_19_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SearchComponent_div_19_Template_div_click_1_listener() {
            ...
            return ctx_r16.openProjectReports(item_r7, item_r7.output);
          });
        ...
        _createClass(SearchComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.route.paramMap.subscribe(function (param) {
              _this29.query = param.params.query;
              console.log(_this29.query);
          ...
          value: function search() {
            ...
            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_0___default.a(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["\n    query search($query: String!,) { \n      search(query:$query) \n      {\n      projects{\n        id\n        title\n        score\n        images\n        status\n        logframes{\n                  id\n                  comments\n                  challenges\n                  outputValue\n                  longitude\n                  latitude\n                  images\n                  status\n                  qow\n                  loc\n                  type\n                  budget\n                  approved\n                  released\n                  utilized\n                  logframeStatus\n                  project{\n                    id\n                    title\n                  }\n\n                 }\n        budget\n        mda{\n          shortcode\n        }\n        output {\n          id\n        title\n        actual\n        baseline\n        target\n        \n        mandates  {\n          id \n          title\n        }\n        }\n      }\n        outputs {\n          id\n        title\n        score\n        actual\n        baseline\n        target\n        mda{\n          shortcode\n        }\n        }\n        indicators {\n          id\n        title\n        score\n        actual\n        baseline\n        target\n        mda{\n          shortcode\n        }\n        }\n        results\n  }\n}\n"])));
            this.crud.pullData(data, {
              query: this.query
            }).subscribe(function (result) {
              var res = [].concat(_toConsumableArray(result.data['search'].projects), _toConsumableArray(result.data['search'].outputs), _toConsumableArray(result.data['search'].indicators));
              _this30.results = res.sort(function (a, b) {
                return b.score - a.score;
              });

              _this30.reset();

              _this30.filter(null, 'All');

              console.log(_this30.results);
              _this30.resultsCount = result.data['search'].results;
              _this30.loaded = true;
            });
          }
        }, {
          ...
          value: function prepareTarget(data, index) {
            if (data == null) return [];
            var tar = JSON.parse(data); // //console.log(tar);
          ...
          value: function filter(ev, type) {
            ...
            if (ev.currentTarget.checked) {
              ...
              if (this.filters.length == 0) this.filtered = this.results;
              return;
            }

            this.filtered = this.results.filter(function (res) {
              return _this31.filters.includes(res.__typename);
            });
          }
        }, {
          key: "openProjectReports",
      ...
      SearchComponent.ɵfac = function SearchComponent_Factory(t) {
        return new (t || SearchComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_service_crud_service__WEBPACK_IMPORTED_MODULE_2__["CrudService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]));
      };
      ...
      SearchComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        ...
        decls: 23,
        vars: 11,
        consts: [[1, "container-fluid"], [1, "m-3", "mr-5", "pr-5"], [1, "m-4"], [1, "row"], [1, "col-3"], [1, "filter", "primary-border"], [1, "list-unstyled", "p-3", "filter"], [1, "pt-4"], ["class", "cats", 4, "ngFor", "ngForOf"], [1, "col-9", "primary-border"], [1, "mt-3"], ["style", "background-color:#28a745; color:white !important; border-radius: 5px; font-size:11px;", "class", "d-inline-block p-1 mr-2   mb-2", 4, "ngFor", "ngForOf"], ["class", "card my-2", 4, "ngFor", "ngForOf"], [1, "text-center", "my-5"], [3, "pageChange"], [1, "cats"], ["type", "checkbox", "name", "type", "value", "", 1, "mr-3", 3, "id", "change"], [3, "for"], [1, "d-inline-block", "p-1", "mr-2", "mb-2", 2, "background-color", "#28a745", "color", "white !important", "border-radius", "5px", "font-size", "11px"], [1, "card", "my-2"], [1, "card-body", "cursor", 3, "click"], [1, "col-6"], [1, "badge"], [4, "ngIf"], ["class", "col-6 text-center d-flex align-items-center", 4, "ngIf"], [1, "col-6", "text-center", "d-flex", "align-items-center"], [1, "w-25"]],
        template: function SearchComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("pageChange", function SearchComponent_Template_pagination_controls_pageChange_22_listener($event) {
              return ctx.p = $event;
            });
        ...
        directives: [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["ɵangular_packages_forms_forms_ba"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["NgForm"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], ngx_pagination__WEBPACK_IMPORTED_MODULE_6__["PaginationControlsComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"]],
        pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["DecimalPipe"], ngx_pagination__WEBPACK_IMPORTED_MODULE_6__["PaginatePipe"], _suffixes_pipe__WEBPACK_IMPORTED_MODULE_7__["SuffixesPipe"]],
    ...
    function vY5A(module, __webpack_exports__, __webpack_require__) {
      ...
      var _dashboard_home_dashboard_home_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./dashboard-home/dashboard-home.component */
      "lr2i");
      /* harmony import */


      var _all_outcomes_all_outcomes_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./all-outcomes/all-outcomes.component */
      "cQWv");
      /* harmony import */


      var _strategic_plan_strategic_plan_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./strategic-plan/strategic-plan.component */
      "nM3Y");
      /* harmony import */


      var _presidential_mandate_presidential_mandate_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./presidential-mandate/presidential-mandate.component */
      "7TvS");
      /* harmony import */


      var _mda_mda_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./mda/mda.component */
      "a3qC");
      /* harmony import */


      var _account_user_login_user_login_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./account/user-login/user-login.component */
      "6nnL");
      /* harmony import */


      var _service_auth_auth_guard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var _ews_ews_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./ews/ews.component */
      "CJl5");
      /* harmony import */


      var _project_details_project_details_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./project-details/project-details.component */
      "OVWj");
      /* harmony import */


      var _output_output_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./output/output.component */
      "z+Vf");
      /* harmony import */


      var _priority_priority_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./priority/priority.component */
      "pZjM");
      /* harmony import */
      ...
      AppRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵdefineNgModule"]({
        type: AppRoutingModule
      });
      AppRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_16__["ɵɵdefineInjector"]({
    ...
    /***/
    function zVf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _all_outcomes_states_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../all-outcomes/states.json */
      "vumz");

      var _all_outcomes_states_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(
      /*! ../all-outcomes/states.json */
      "vumz", 1);
      /* harmony import */
      ...
      function OutputComponent_ul_57_li_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function OutputComponent_ul_57_li_1_Template_a_click_1_listener() {
            ...
            return ctx_r8.filterByMda(item_r7);
          });
      ...
      function OutputComponent_ul_57_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function OutputComponent_ul_62_li_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function OutputComponent_ul_62_li_1_Template_a_click_1_listener() {
            ...
            return ctx_r12.filterByState(item_r11.state);
          });
      ...
      function OutputComponent_ul_62_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "ul", 31);
      ...
      function OutputComponent_p_67_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function OutputComponent_table_68_tr_20_span_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span");
      ...
      function OutputComponent_table_68_tr_20_span_5_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "span");
      ...
      function OutputComponent_table_68_tr_20_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function OutputComponent_table_68_tr_20_Template_em_click_23_listener() {
            ...
            return ctx_r19.openProjectReports(item_r15, ctx_r19.outputData.output);
          });
      ...
      function OutputComponent_table_68_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function OutputComponent_pagination_controls_69_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("pageChange", function OutputComponent_pagination_controls_69_Template_pagination_controls_pageChange_0_listener($event) {
      ...
      var OutputComponent = /*#__PURE__*/function () {
        function OutputComponent(router, crud) {
        ...
        _createClass(OutputComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.ongoing = this.projects.filter(function (e) {
              return e.status === 'ongoing';
            });
            this.completed = this.projects.filter(function (e) {
              return e.status === 'completed';
            });
            this.abandoned = this.projects.filter(function (e) {
              return e.status === 'abandoned';
            });
            console.log(this.ongoing.length, this.completed.length, this.abandoned.length, this.projects.length);
            this.searchControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["debounceTime"])(100)).subscribe(function (search) {// this.search(search);
          ...
          key: "filterByMda",
          value: function filterByMda(item) {}
        }, {
          key: "getMdas",
          value: function getMdas() {
            var _this32 = this;

            var data = graphql_tag__WEBPACK_IMPORTED_MODULE_1___default.a(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["\n    {\n      mdas{\n        id\n        name\n        indicators{\n            id\n            title\n            ref\n            type\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            mdaId\n            outputs{\n            id\n            title\n            ref\n            baseline\n            actual\n            target\n            aggregation\n            rt\n            currency\n            active\n            mda{\n              id\n              name\n              shortcode\n            }\n          }\n          }\n        }\n      }\n  "])));
            this.crud.pullData(data, {}).subscribe(function (result) {
              // this.currentPriorities = ''
              _this32.mdas = result.data.mdas; // for (let el of this.mdas) {
              //   el.data = [...el.indicators];
              // }
              // console.log(this.mdas);
              // this.temp = result.data.priorities;
          ...
          key: "filterByState",
          value: function filterByState(item) {}
        }, {
          key: "clearFilters",
          value: function clearFilters(item) {}
        }, {
          key: "openProjectReports",
          value: function openProjectReports(item, ind) {
            this.router.navigate(['/dashboard/project-details'], {
      ...
      OutputComponent.ɵfac = function OutputComponent_Factory(t) {
        return new (t || OutputComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_service_crud_service__WEBPACK_IMPORTED_MODULE_5__["CrudService"]));
      };

      OutputComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        type: OutputComponent,
        selectors: [["app-output"]],
        decls: 70,
        vars: 10,
        consts: [[1, "container-fluid", "px-4", "my-5"], [1, "p-4", "primary-border"], [1, "d-flex", "pt-4", "text-center", "flex-wrap"], [1, "col-md-3", "px-2", "mb-3"], [1, "p-2", "secondary-card"], ["title", "Stabilize the Macro Economic Environment", 1, "chart-small-label"], [1, "container-fluid"], [1, "primary-border", "p-4"], [1, "projects"], [1, "container-header", "px-4", "pt-4", "pb-3"], [1, "row"], [1, "col-md-5"], [1, "mb-0", "label"], [1, "text-left"], [1, "mr-2"], ["width", "20", "src", "assets/icons/flag.svg"], ["width", "20", "src", "assets/icons/red-warning.svg"], [1, "col-md-7"], ["type", "text", "name", "search", "placeholder", "Search...", 1, "form-control", "search-input", 3, "formControl"], ["search", ""], ["dropdown", "", 1, "btn-group", "mr-3"], ["id", "button-basic", "dropdownToggle", "", "type", "button", "aria-controls", "dropdown-basic", 1, "btn", "btn-primary", "dropdown-toggle"], [1, "caret"], ["id", "dropdown-basic", "class", "dropdown-menu", "role", "menu", "aria-labelledby", "button-basic", 4, "dropdownMenu"], ["dropdown", "", 1, "btn-group"], [1, "ml-3", "green"], ["href", "javascript:void(0)", 3, "click"], [1, "table-responsive", "p-4"], ["class", "gray text-center ", 4, "ngIf"], ["class", "table table-bordered mt-3", "id", "projectTabel", "style", "width:100%", 4, "ngIf"], [3, "pageChange", 4, "ngIf"], ["id", "dropdown-basic", "role", "menu", "aria-labelledby", "button-basic", 1, "dropdown-menu"], ["role", "menuitem", 4, "ngFor", "ngForOf"], ["role", "menuitem"], [1, "dropdown-item", 3, "click"], [1, "gray", "text-center"], ["id", "projectTabel", 1, "table", "table-bordered", "mt-3", 2, "width", "100%"], ["colspan", "2"], [4, "ngFor", "ngForOf"], [4, "ngIf"], [1, ""], [1, "status", 2, "margin-top", "2px", "margin-right", "2px", "vertical-align", "middle", 3, "ngClass"], [1, "d-inline-block", 2, "vertical-align", "middle"], [1, "cursor", 3, "click"], ["src", "assets/icons/flag.svg", 1, "mr-2"], ["src", "assets/icons/red-warning.svg", 1, "mr-2"], [3, "pageChange"]],
        template: function OutputComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](43, " \xA0 \xA0 ");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function OutputComponent_Template_a_click_64_listener() {
              return ctx.clearFilters(ctx.outputData.output.projects);
            });
        ...
        pipes: [ngx_pagination__WEBPACK_IMPORTED_MODULE_9__["PaginatePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_8__["DecimalPipe"], ngx_moment__WEBPACK_IMPORTED_MODULE_10__["DateFormatPipe"], ngx_moment__WEBPACK_IMPORTED_MODULE_10__["FromUtcPipe"]],
